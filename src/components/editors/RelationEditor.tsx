...
export default class RelationEditor extends Component<IProps, IState> {
    ...
    render() {
        const {
            ...
            model,
            onRelationChange,
            onRelationFromRefChange,
            onRelationToRefChange,
            onRelationFromCardinalityChange,
            onRelationToCardinalityChange,
            onRelationDelete,
            onDismiss
        } = this.props;
                    ...
                    <table className='w-full text-left table-collapse'>
                        ...
                        <tr>
                            <td className='table__cell'>
                                <select className='form__input form__input--select' value={relation.from.ref}
                            ...
                            <td className='table__cell'>
                                <select className='form__input form__input--select' value={relation.from.cardinality}
                            ...
                            <td className='table__cell'>
                                <select className='form__input form__input--select' value={relation.to.ref}
                                    onChange={e => onRelationToRefChange(relation.id, e.target.value)}>
                                    {model.entities.map(entity => <option key={entity.id} value={entity.id}>{entity.name}</option>)}
                                </select>
                            </td>
                            <td className='table__cell'>
                                <select className='form__input form__input--select' value={relation.to.cardinality}
